...
using WebCalzadosAnnies.Core.Identity;
using WebCalzadosAnnies.Models;
...
namespace WebCalzadosAnnies.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            {
                return RedirectToLocal(Annies.Common.Constants.ConfigurationKeys.DefaultRedirect);
            }
        ...
        public async Task<ActionResult> Login(LoginViewModel modelView, string returnUrl)
        {
            ...
            if (result.Usuario.InternalStatus == Annies.Common.EnumTypes.InternalStatus.Success)
            {
